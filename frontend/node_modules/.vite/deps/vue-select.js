        ...
        return (() => {
          ...
          const l = { props: { autoscroll: { type: Boolean, default: true } }, watch: { typeAheadPointer: function() {
            ...
            if (t3) {
              ...
              if (i2 < n2.top)
                return this.$refs.dropdownMenu.scrollTop = t3.offsetTop;
              if (s2 > n2.bottom)
                return this.$refs.dropdownMenu.scrollTop = t3.offsetTop - (n2.height - r2);
            }
          ...
          const m = p({ components: v({}, h), directives: { appendToBody: d }, mixins: [l, c, u], props: { value: {}, components: { type: Object, default: function() {
            ...
            var t3 = this, n2 = function(e4) {
              ...
              if (e4.preventDefault(), t3.open)
                return t3.typeAheadUp();
              t3.open = true;
            }, 40: function(e4) {
              if (e4.preventDefault(), t3.open)
                return t3.typeAheadDown();
              t3.open = true;
            } };
            ...
            if ("function" == typeof i2[e3.keyCode])
            ...
            return n2("div", { staticClass: "v-select", class: e3.stateClasses, attrs: { dir: e3.dir } }, [e3._t("header", null, null, e3.scope.header), e3._v(" "), n2("div", { ref: "toggle", staticClass: "vs__dropdown-toggle", attrs: { id: "vs" + e3.uid + "__combobox", role: "combobox", "aria-expanded": e3.dropdownOpen.toString(), "aria-owns": "vs" + e3.uid + "__listbox", "aria-label": "Search for option" }, on: { mousedown: function(t4) {
